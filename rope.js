class Rope
  {
    ...
    //nlink= number of rectangles needed to make a rope 
    //pointA= point of connection or commencement of rope 
    {
      this.nlink = nlink
  const group = Body.nextGroup(true);

  //composite= here it implies collection of rectangles to make a rope 
